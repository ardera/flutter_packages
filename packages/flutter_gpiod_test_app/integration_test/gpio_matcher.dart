...
class _GpioLineHasInfo extends CustomMatcher {
  _GpioLineHasInfo(matcher)
      : super('GpioLine with info that is', 'info', matcher);
...
class _LineInfoHasName extends CustomMatcher {
  _LineInfoHasName(matcher)
      : super("LineInfo with name that is", "name", matcher);
...
class _LineInfoHasConsumer extends CustomMatcher {
  _LineInfoHasConsumer(matcher)
      : super('LineInfo with consumer that is', 'consumer', matcher);
...
class _LineInfoHasIsUsed extends CustomMatcher {
  _LineInfoHasIsUsed(matcher)
      : super('LineInfo with isUsed that is', 'isUsed', matcher);
...
class _LineInfoHasIsRequested extends CustomMatcher {
  _LineInfoHasIsRequested(matcher)
      : super('LineInfo with isRequested that is', 'isRequested', matcher);
...
class _LineInfoHasIsFree extends CustomMatcher {
  _LineInfoHasIsFree(matcher)
      : super('LineInfo with isFree that is', 'isFree', matcher);
...
class _LineInfoHasDirection extends CustomMatcher {
  _LineInfoHasDirection(matcher)
      : super('LineInfo with direction that is', 'direction', matcher);
...
class _LineInfoHasOutputMode extends CustomMatcher {
  _LineInfoHasOutputMode(matcher)
      : super('LineInfo with outputMode that is', 'outputMode', matcher);
...
class _LineInfoHasBias extends CustomMatcher {
  _LineInfoHasBias(matcher)
      : super('LineInfo with bias that is', 'bias', matcher);
...
class _LineInfoHasActiveState extends CustomMatcher {
  _LineInfoHasActiveState(matcher)
      : super('LineInfo with activeState that is', 'activeState', matcher);
