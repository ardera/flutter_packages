...
class LibCPlatformBackend {
  ...
  late final _ioctlPtr = _lookup<ffi.NativeFunction<ffi.Int32 Function(ffi.Int32, ffi.Uint64)>>('ioctl');
  ...
  late final _openPtr = _lookup<ffi.NativeFunction<ffi.Int32 Function(ffi.Pointer<ffi.Int8>, ffi.Int32)>>('open');
  late final _open = _openPtr.asFunction<int Function(ffi.Pointer<ffi.Int8>, int)>(isLeaf: true);
  ...
  late final _readPtr =
      _lookup<ffi.NativeFunction<ffi.Int64 Function(ffi.Int32, ffi.Pointer<ffi.Void>, ffi.Uint64)>>('read');
...
class _SymbolAddresses {
  ...
  ffi.Pointer<ffi.NativeFunction<ffi.Int32 Function(ffi.Int32, ffi.Uint64)>> get ioctl => _library._ioctlPtr;
  ...
  ffi.Pointer<ffi.NativeFunction<ffi.Int64 Function(ffi.Int32, ffi.Pointer<ffi.Void>, ffi.Uint64)>> get read =>
      _library._readPtr;
}
...
class gpiochip_info extends ffi.Struct {
  ...
  @ffi.Array.multi([32])
  external ffi.Array<ffi.Int8> label;
...
class gpio_v2_line_request extends ffi.Struct {
  ...
  @ffi.Array.multi([32])
  external ffi.Array<ffi.Int8> consumer;
...
class gpiohandle_request extends ffi.Struct {
  ...
  @ffi.Array.multi([32])
  external ffi.Array<ffi.Int8> consumer_label;
