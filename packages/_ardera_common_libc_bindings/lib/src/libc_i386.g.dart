...
class LibCPlatformBackend {
  ...
  late final _readPtr = _lookup<ffi.NativeFunction<ffi.Int Function(ffi.Int, ffi.Pointer<ffi.Void>, ffi.Size)>>('read');
...
class _SymbolAddresses {
  ...
  ffi.Pointer<ffi.NativeFunction<ffi.Int Function(ffi.Int, ffi.Pointer<ffi.Void>, ffi.Size)>> get read =>
      _library._readPtr;
}
