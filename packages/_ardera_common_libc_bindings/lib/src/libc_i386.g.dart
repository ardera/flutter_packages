...
class LibCI386 {
  ...
  LibCI386.fromLookup(ffi.Pointer<T> Function<T extends ffi.NativeType>(String symbolName) lookup) : _lookup = lookup;
...
final class stat_buf extends ffi.Struct {
  ...
  @ffi.UnsignedLong()
  external int __glibc_reserved4;

  @ffi.UnsignedLong()
  external int __glibc_reserved5;
}
